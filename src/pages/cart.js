                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="product-thumbnail"><a href="single-product.html">
                                <Image src="/assets/images/product/electric/product-01.png" alt="Digital Product" width={80} height={80}/></a></td>
                        ...
                        <tr>
                            <td class="product-remove"><a href="#" class="remove-wishlist"><i class="fal fa-times"></i></a></td>
                            <td class="product-thumbnail"><a href="single-product-2.html">
                                <Image src="/assets/images/product/electric/product-02.png" alt="Digital Product" width={80} height={80} /></a></td>
                        ...
                        <tr>
                            <td class="product-remove"><a href="#" class="remove-wishlist"><i class="fal fa-times"></i></a></td>
                            <td class="product-thumbnail"><a href="single-product-3.html">
                                <Image src="/assets/images/product/electric/product-03.png" alt="Digital Product" width={80} height={80} /></a></td>
